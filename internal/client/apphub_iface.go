...
type appHubClient interface {
	...
	ListDiscoveredServices(ctx context.Context, req *apphubpb.ListDiscoveredServicesRequest, opts ...gax.CallOption) (*apphubpb.ListDiscoveredServicesResponse, error)
	ListDiscoveredWorkloads(ctx context.Context, req *apphubpb.ListDiscoveredWorkloadsRequest, opts ...gax.CallOption) (*apphubpb.ListDiscoveredWorkloadsResponse, error)
